            ...
            <div>
                <div className="jumbotron text-center">
                    ...
                    <p className="mx-auto" style={{maxWidth: 600}}>
                        We firmly believe that life doesn't need to be complicated. Visit our data portal for easy
                        access to near real time & ready-to-use satellite data.
                    </p>
                    <br/>
            ...
            <div className="col-md-4 col-sm-12">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime consectetur laudantium inventore quae, libero, cum. Fugiat perferendis omnis</p>
                ...
                <div className="container my-5 pt-5" style={{maxWidth: 600}}>
                    ...
                    <p>
                        We are here for any information driven entity with the need for more frequent, affordable and
                        actionable information for decision making, (market) research, monitoring, management, and
                        advocacy related to land use & land cover (changes) all over the world.
                    </p>
                </div>
                <div className="container my-5 border-top pt-5" style={{maxWidth: 600}}>
                    ...
                    <p>
                        Make use of our Machine Learning expertise and data infrastructure to leverage the insights that
                        satellite data can give you. Through automated analysis using artificially intelligent image
                        recognition models we can help you make sense of Earth Observation data for at any scale. All
                        you need to do, is choose the service and subscription that fits you best.
                    </p>
                    <ul>
                        ...
                        <li>Or choose to view fully classified data on land use and land cover so you can spend more
                    ...
                    <div className="card-deck mb-3 text-center" style={{marginTop: 30}}>
                        <div className="card mb-4 box-shadow">
                            ...
                            <div className="card-body">
                                <h3 className="card-title pricing-card-title"><h3>€20</h3>
                                ...
                                <ul className="list-unstyled mt-3 mb-4">
                                    ...
                                    <ul className="list-unstyled mt-3 mb-4">
                                        <li>Land area monitoring and notifications based on model and location (0,1-0,8
                                            eur/km2)
                                        </li>
                        ...
                        <div className="card mb-4 box-shadow" style={{marginTop: -30}}>
                            ...
                            <div className="card-body">
                                <h3 className="card-title pricing-card-title">€20 000 -
                                    <h3>€100 000</h3>
                                    <small className="text-muted">/ setup</small>
                                </h3>
                                <h4 className="card-title pricing-card-title"><strong>€5 000 - €20 000</strong>
                                    <small className="text-muted">/ year following</small>
                                </h4>
                                <ul className="list-unstyled mt-3 mb-4">
                                    <li>Dedicated model development with permission for open source or 3rd party usage
                                    </li>
                ...
                <div className="container my-5 border-top pt-5" style={{maxWidth: 600}}>
                    ...
                    <p>
                        Bird’sAI helps people make use of the penta bytes of satellite data that is being generated
                        every day. Through AI technology, we make it our mission to present people who want to
                        leverage
                        haystacks of potentially useful data, with the needles they were looking for.
                    </p>

                    <img src="/team.jpg" className="img-fluid rounded" alt=""/>

                    <div className="my-4" style={{borderLeft: '5px solid #eee', paddingLeft: 10}}>
                        Strive for elegant and scalable solutions. At the intersection of AI and Earth Observation
                        many
                        awesome things are yet to be achieved.
                    </div>

                    <div className="mb-4" style={{borderLeft: '5px solid #eee', paddingLeft: 10}}>
                        Driven to connect more people to better information, because good things happen when we
                        understand our environment.
                    </div>

                    <div className="mb-4" style={{borderLeft: '5px solid #eee', paddingLeft: 10}}>
                        Taking on challenges and learning new skills are the only ways to get things done. The world
                        changes too quickly to stick to old tricks.
                    </div>
                </div>
